/**
 * Mapeamento de traduções para as opções das questões
 * Chave = ID da questão
 * Valor = Array de 4 opções traduzidas para português
 */
...
const OPTION_TRANSLATIONS = {
  ...
  18: ["Personaliza para padrões de org", "Ignora padrões", "Apenas código público", "Não consegue customizar"],
